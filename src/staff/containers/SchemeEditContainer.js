...
const mapStateToProps = (state, ownProps) => {
    ...
    return {
        ...
        gradings: state.gradings.contentMin,

        modesForSelect: getAllModesForSelect(state), // nullable
        modes: state.modes.content,
        ...
        gradingsTwoPoint:state.gradingsTwoPoint.content,
        gradingsFourPointForSelect:getAllGradingsFourPointForSelect(state),
        gradingsFourPoint:state.gradingsFourPoint.content,
        gradingsFreePointForSelect:getAllGradingsFreePointForSelect(state),
        gradingsFreePoint:state.gradingsFreePoint.content,
