...
const DepTable = props => {
    ...
    const {userInfo, departments, faculties, organisations} = props;
    ...
    const columns = [
        ...
        },
        {
            ...
            title: cell => cell,
            editable: false,
            hidden: !authenticated.isGlobalAdmin ? true : false,
        },
        {
            ...
            title: cell => cell,
            editable: false,
            hidden: !authenticated.isAtLeastOrgAdmin ? true : false,
        },
        ...
        },
        {
            ...
            formatter: (cell, row) => {
                const {depId} = row;
                return (
                    <a href="#" className="badge badge-info" onClick={() => setEditMode({mode: true, editableDepId: depId})}>
                        <FaPencilAlt/>
                    </a>);
            }
        },
