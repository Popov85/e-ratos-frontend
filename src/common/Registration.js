...
import RegistrAPI from "../session/_api/registrAPI";
...
class Registration extends Component {
    ...
    loadOrgId() {
        RegistrAPI.loadOrganization(this.errorLoadOrgId).then(orgId => {
    ...
    loadOrg() {
        const { isLmsContext } = this.state;
        RegistrAPI.loadOrganizations(isLmsContext, this.errorLoadOrg).then(organisations => {
    ...
    loadFac(orgId) {
        const { isLmsContext } = this.state;
        RegistrAPI.loadFaculties(isLmsContext, orgId, this.errorLoadFac).then(faculties => {
    ...
    loadClasses(facId) {
        const { isLmsContext } = this.state;
        RegistrAPI.loadClasses(isLmsContext, facId, this.errorLoadClass).then(classes => {
