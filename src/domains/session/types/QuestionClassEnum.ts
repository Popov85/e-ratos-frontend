...
export enum QuestionClassEnum {
    ...
    QuestionMQClass = 'ua.edu.ratos.service.dto.session.question.QuestionMQSessionOutDto',
    QuestionSQClass = 'ua.edu.ratos.service.dto.session.question.QuestionSQSessionOutDto'
}