...
const testMcqMultiChecked = {
    question: {
        ...
        answers: [
            ...
            {
                answerId: 124829,
                answer: "Answer (correct) #3 to question #31222 answer: 0dfa00y96wp43 94xc0prondo853k w507arcul o42nb y56xl b5ryimnm0hk dzal86x x xjwz hah 3wmif4gvmlcihph 715g 36ybf09p26utqu cbxiq0ks0u enlg 72agcc4471q19l d v5sosid wt94df .",
            }
        ]
    },
    ...
    correctAnswer: {
        correctAnswers: [
            {answerId: 124829, percent: 50, required: true},
            {answerId: 124830, percent: 50, required: true}
        ],
    },
    score: 0,
}
...
const initSession = {
    ...
    batch: realBatch,
    batchNumber: 1,
    questionNumber: 0, //counter: 0,

    help: false,
    report: false, // Report mode activate: move to hooks?
    paused: false,
    cancelled: false,
    ...
    preserved: {state: false, key: null},
